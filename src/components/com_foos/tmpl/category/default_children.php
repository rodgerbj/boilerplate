...
?>
<ul class="com-foos-category__children list-striped list-condensed">
	...
	<li>
		<h4 class="item-title">
			...
			<?php if ($this->params->get('show_cat_items') == 1) : ?>
				<span class="badge badge-info float-right" title="<?php echo Text::_('COM_FOOS_CAT_NUM'); ?>"><?php echo $child->numitems; ?></span>
			<?php endif; ?>
		</h4>
